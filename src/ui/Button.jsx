...
function Button({ children, disabled = false, type = "primary", to, onClick }) {
  const base = `inline-block text-sm rounded-full font-semibold uppercase ${
    disabled ? "bg-yellow-500/70" : "bg-yellow-400"
